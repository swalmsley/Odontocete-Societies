...
list(
  ...
  ## Lifespan
  tar_target(m1q, brm(Q ~ lifespan_Post.Mean_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                     family = 'Beta', data = data_Q, data2 = list(A=A),
                     prior = c(prior("normal(0,5)", class = "Intercept"),
                               prior("normal(0,1)", class = "b")),
                     control=list(adapt_delta=0.99, max_treedepth=15),
                     iter = 4000, chains = 4, cores = 4)),
  tar_target(m1s, brm(S ~ lifespan_Post.Mean_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                     family = 'Gamma', data = data_S, data2 = list(A=A),
                     prior = c(prior("normal(0,5)", class = "Intercept"),
                               prior("normal(0,1)", class = "b")),
                     control=list(adapt_delta=0.99, max_treedepth=15),
                     iter = 4000, chains = 4, cores = 4)),
  tar_target(m1q_IVSO, brm(Q_IVSO ~ lifespan_Post.Mean_F + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsQ>1,,], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m1s_IVSO, brm(S_IVSO ~ lifespan_Post.Mean_F + (1|Species) + (1|gr(phylo, cov = A)),
  ...
  ## Age at maturity
  tar_target(m2q, brm(Q ~ age.mat_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Beta', data = data_Q, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m2s, brm(S ~ age.mat_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_S, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m2q_IVSO, brm(Q_IVSO ~ age.mat_F + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsQ>1], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m2s_IVSO, brm(S_IVSO ~ age.mat_F + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsS>1], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
  ...
  # Body length
  tar_target(m3q, brm(Q ~ log_length_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Beta', data = data_Q, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m3s, brm(S ~ log_length_F + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_S, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
  ...
  tar_target(m3s_noTransform, brm(S ~ scale(length.mean_F) + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      ...
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m3q_IVSO, brm(Q_IVSO ~ log_length_F + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsQ>1,,], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m3s_IVSO, brm(S_IVSO ~ log_length_F + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsS>1], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
  ...
  tar_target(m4q, brm(Q ~ SSD + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Beta', data = data_Q, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m4s, brm(S ~ SSD + (1|AssociationIndex) + (1|Species) + (1|Population) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_S, data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m4q_IVSO, brm(Q_IVSO ~ SSD + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsQ>1], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
                      iter = 4000, chains = 4, cores = 4)),
  tar_target(m4s_IVSO, brm(S_IVSO ~ SSD + (1|Species) + (1|gr(phylo, cov = A)),
                      family = 'Gamma', data = data_IVSO[numObsS>1], data2 = list(A=A),
                      prior = c(prior("normal(0,5)", class = "Intercept"),
                                prior("normal(0,1)", class = "b")),
                      control=list(adapt_delta=0.99, max_treedepth=15),
